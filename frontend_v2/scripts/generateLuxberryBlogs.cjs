...
const workbookPath = path.resolve(__dirname, "../public/Luxberry_Blogs.xlsx");
const outputPath = path.resolve(__dirname, "../src/data/luxberryBlogs.json");
...
const main = async () => {
    ...
    console.log(`Generated ${articles.length} LuxBerry blog articles.`);
};
